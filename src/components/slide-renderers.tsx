...
export function CoverSlide({ title, subtitle, date, company }: CoverSlideProps) {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[700px] max-h-[700px] overflow-hidden">
...
export function TocSlide({ items, onNavigate }: TocSlideProps) {
  return (
    <div className="min-h-[700px] max-h-[700px] overflow-y-auto py-8 px-4">
      {/* 헤더 */}
...
export function DividerSlide({ act, title, subtitle }: DividerSlideProps) {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[700px] max-h-[700px] overflow-hidden bg-gradient-to-br from-[#004B8D] via-[#004B8D] to-[#48A9C5] -m-8 md:-m-12 lg:-m-16 p-8 md:p-12 lg:p-16">
      {/* 배경 패턴 */}
...
export function ContentSlide({ title, content, bullets, emphasis, tone = "neutral" }: ContentSlideProps) {
  ...
  return (
    <div className="min-h-[700px] max-h-[700px] overflow-y-auto py-8 space-y-8">
      {/* 타이틀 */}
      <div className="space-y-2">
